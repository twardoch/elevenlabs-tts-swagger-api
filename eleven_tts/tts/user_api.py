...
class UserApi(object):
    ...
    def get_user_info_v1_user_get(self, **kwargs):  # noqa: E501
        """Get User Info  # noqa: E501

        Gets information about the logged in user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_info_v1_user_get(async_req=True)
        >>> result = thread.get()
        ...
        :return: ElevenUserResponseModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_info_v1_user_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_user_info_v1_user_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_user_info_v1_user_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get User Info  # noqa: E501

        Gets information about the logged in user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_info_v1_user_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_user_info_v1_user_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ElevenUserResponseModel',  # noqa: E501
